      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li class="active"><a href="welcomeSeller.jsp">Home</a></li>
...
<body>
      ...
      <div>
          <h1 align="center">Own Products</h1>
          </div>
  ...
  <div class="container">
        <form action="payment.htm" method="POST">
            ...
            <tr>
 			...
 			<c:forEach items="${allProducts}" var="ordered"> 
                ...
                <tr>
                    ...
                    <td><input type="text" name="doctorVisit" value="${ordered.productName}" readonly/>  </td>
                    <td><input type="text" name="conisurancePercent" value="${ordered.quantity}" readonly/>  </td>
                    <td><input type="text" name="deductibleLimit" value="${ordered.price}" readonly/>  </td>
